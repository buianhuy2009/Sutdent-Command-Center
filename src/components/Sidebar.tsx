...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside
      ...
      data-tour="sidebar"
      role="navigation"
      className={`h-screen shrink-0 bg-[#EACB8D] dark:bg-[#1A1917] border-r border-[#D4AF6E] dark:border-[#2C2B27] flex flex-col transition-all duration-300 z-30 select-none ${
                ...
                <div key={app.id} className="relative group/item flex items-center">
                  ...
                  >
                    ...
                    {isExpanded ? (
                      ...
                      <>
                        {hasBadge && (
                          <span className={`absolute -top-1 -right-1 w-2.5 h-2.5 rounded-full ring-2 ring-[#EACB8D] dark:ring-[#282723] ${badgeColor}`} />
                        )}
