...
export const APP_CATALOG: AppStoreItem[] = [
  // 1. LMS & Schedule
  {
    ...
    longOverview: 'StudentOS Canvas LMS automatically synchronizes all your university and high school coursework, course syllabi, assignment rubrics, and submission deadlines into a single high-density workspace.',
    ...
    developer: 'Instructure & StudentOS',
    rating: 4.9,
  },
  {
    id: 'radar',
    ...
    longOverview: 'A master visual timetable uniting Google Calendar events, Canvas assignment deadlines, and AI-suggested study focus blocks into an organized daily agenda.',
    ...
    badge: 'Essential',
    isDefaultPinned: true,
    developer: 'StudentOS Calendar Team',
    rating: 4.8,
  },
  {
    id: 'tracker',
    ...
    longOverview: 'The central command center for all coursework. Syncs two-way with your Google Sheets master tracker, offers AI-powered natural language task parsing, and calculates effort/risk matrices.',
    ...
    badge: 'Essential',
    isDefaultPinned: true,
    developer: 'StudentOS Productivity Lab',
    rating: 5.0,
  },
  {
    id: 'gmail',
    ...
    longOverview: 'Scans your university inbox, filters out campus spam and promotion newsletters, extracts assignment due dates, and drafts respectful, context-aware email replies to professors.',
    features: ['Academic vs Spam classification AI', '1-click "Create Task from Email" action', 'Socratic professor email drafter', 'Master-detail two-pane reader'],
    badge: 'AI Powered',
    isDefaultPinned: true,
    developer: 'Google Workspace & StudentOS',
    rating: 4.9,
  },
  {
    id: 'classroom',
    ...
    longOverview: 'Directly integrates with Google Classroom API to pull assignments, classroom announcements, course materials, and attachments into your unified student queue.',
  ...
  },
  {
    ...
    longOverview: 'Run any two academic tools side-by-side with an adjustable split ratio. Take notes while graphing on Desmos, or browse Google Drive while writing LaTeX.',
  ...
  // 2. STEM & Math
  {
    ...
    longOverview: 'The gold-standard 2D graphing calculator for high school and university mathematics. Plot explicit, implicit, parametric, and polar equations with interactive sliders.',
  ...
  },
  {
    ...
    longOverview: 'Upload a picture of your handwritten calculus or algebra solution. Google Gemini AI reads your equations, verifies each step, and highlights algebra errors with yellow step-by-step corrections.',
    features: ['Multimodal OCR equation recognition', 'Step-by-step arithmetic verification', 'Yellow error highlight & explanation', 'LaTeX formula copy & export'],
    badge: 'AI Vision',
  ...
  },
  {
    ...
    category: 'Visual & Design',
    description: 'Slide decks, academic posters, and infographic studio.',
    longOverview: 'Quick access to your Canva presentations, academic research posters, group project slide decks, and visual study infographics.',
    features: ['Direct Canva workspace bridge', 'Academic poster & presentation templates', 'Group project visual collaboration', 'Export to PDF and slide decks'],
    badge: 'Design',
  ...
  // 4. Study & Retention
  {
    ...
    description: 'Spaced repetition flashcards with SuperMemo SM-2 algorithm.',
    longOverview: 'A high-yield spaced repetition flashcard studio powered by the SuperMemo SM-2 algorithm. Generate decks from lecture notes with AI, review cards daily, and export to Anki / Quizlet.',
    features: ['SuperMemo SM-2 spaced repetition engine', 'AI 1-click deck generator from text', 'CSV & Anki-compatible export', 'Mastery streak & ease factor tracking'],
  ...
  {
    id: 'viva',
    name: 'AI Oral Defense / Viva',
    category: 'Study & Retention',
    description: 'Simulated professor voice exam with live evaluation.',
    longOverview: 'Practice for high-stakes oral exams, thesis defenses, and professor questioning. AI asks progressive Socratic questions via voice synthesis and evaluates your spoken answers.',
  ...
  },
  {
    ...
    longOverview: 'Enter deep uninterrupted flow states with a minimalist 25-minute Pomodoro timer, ambient white noise / lo-fi synthesizer, and instant fullscreen zen mode.',
    features: ['Automatic fullscreen & zen focus mode', 'Web Audio API white noise & binaural beats', 'Daily session streak tracker', 'Distraction-free scratchpad'],
    badge: 'Zen Focus',
  ...
  // 5. Writing & Research
  {
    ...
    features: ['Google Drive coursework file index', '1-click peer & professor permission sharing', 'Direct open in Google Docs/Sheets', 'Integrated submission picker'],
    badge: 'Essential',
    isDefaultPinned: true,
  ...
  },
  {
    ...
    longOverview: 'A rapid lecture note-taker featuring live LaTeX math rendering via KaTeX, real-time word and reading time stats, and 1-click Markdown export.',
  ...
  },
  {
    ...
    longOverview: 'Paste your draft essay and assignment grading rubric. Google Gemini AI grades your draft against each rubric criterion and gives actionable revisions to reach an A+.',
  ...
  },
  {
    ...
    category: 'Writing & Research',
    description: 'Explain complex concepts at 5yo, High School & Uni levels.',
    longOverview: 'Master difficult academic concepts by applying the Feynman Technique. AI translates dense textbook theories into intuitive analogies, real-world models, and rigorous derivations.',
  ...
  // 6. New Integrations & High-Yield Tools
  {
    id: 'ai-suite',
    name: 'AI Academic Suite',
    category: 'Study & Retention',
    description: 'Daily study planner, syllabus deadline parser, quiz builder & GPA predictor.',
    longOverview: 'All-in-one cognitive study assistant. Generate energy-optimized daily schedules, extract course deadlines from syllabus PDFs, build interactive exam quizzes, and calculate target scores needed on final exams.',
    features: ['Energy-aware daily time-blocked study planner', 'Syllabus PDF automatic deadline & weight extractor', 'Interactive 5-question multiple choice quiz builder', 'Mathematical final exam score calculator'],
    badge: 'AI Suite',
    developer: 'StudentOS Intelligence',
    rating: 5.0,
  },
  {
    id: 'wolfram-symbolab',
    name: 'Wolfram & Symbolab Math Solver',
    category: 'STEM & Math',
    description: 'Step-by-step calculus, linear algebra, and chemistry problem solver.',
    longOverview: 'Enter complex mathematics, differential equations, integrals, and physics word problems. Get step-by-step algebraic derivations, exact answers, and 1-click links to Wolfram Alpha and Symbolab.',
    ...
    badge: 'Math Solver',
    developer: 'Wolfram & Symbolab Integration',
    rating: 4.9,
  },
  {
    id: 'google-scholar',
    name: 'Google Scholar & Zotero Citations',
    category: 'Writing & Research',
    description: 'Academic paper citations in APA 7th, MLA 9th, Chicago, and BibTeX.',
    longOverview: 'Search any academic source or paste paper titles to instantly generate verified bibliographic citations in APA, MLA, Chicago, Harvard, and BibTeX formats for your bibliography.',
  ...
  },
  {
    ...
    category: 'Writing & Research',
    description: 'Cloud LaTeX document editor and PDF compiler bridge.',
    ...
    badge: 'LaTeX',
    developer: 'Digital Science & Overleaf',
    rating: 4.8,
  },
  {
    id: 'github',
    name: 'GitHub Code & Task Hub',
    category: 'LMS & Schedule',
    description: 'CS coursework repositories, pull requests, and commit tracker.',
    longOverview: 'Track your computer science programming assignments, GitHub repositories, issue trackers, and pull requests directly from your academic command center.',
    features: ['Direct repository quick-launch', 'CS assignment milestone tracker', 'Code snippet repository', 'Commit streak accountability'],
    badge: 'Developer',
  ...
  {
    id: 'discord',
    name: 'Discord & Slack Study Servers',
    category: 'LMS & Schedule',
    description: 'University study group servers, class channels, and office hour chats.',
    longOverview: 'Organize all your university Discord study servers, course Slack workspaces, and peer group chat channels in one focused launcher.',
    ...
    <div className="fixed inset-0 z-50 bg-[#FAF9F5] dark:bg-[#141413] flex flex-col animate-in fade-in duration-150 select-none">
        ...
        <div className="flex items-center gap-4 min-w-0">
          {viewingApp ? (
            ...
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-2xl bg-gradient-to-br from-amber-500 to-[#D97757] text-white flex items-center justify-center font-extrabold text-sm shadow-md shadow-[#D97757]/20">
                A
              </div>
              <div>
                ...
                <p className="text-[11px] text-[#8C897F]">
                  Discover, install &amp; launch 20+ specialized academic tools
                </p>
              </div>
            </div>
          )}
          ...
          <div className="hidden md:flex items-center flex-1 max-w-md mx-8">
            <div className="relative w-full">
              ...
              <input
                ...
                placeholder="Search tools, formulas, simulations, note-takers..."
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {viewingApp ? (
                ...
                >
                  {pinnedAppIds.includes(viewingApp.id) ? (
                    ...
                    <>
                      ...
                      <span>Install / Pin to Sidebar</span>
                    </>
                  )}
                </button>
          ...
          /* VIEW 2: FULLSCREEN SPACIOUS CATALOG GRID */
          <div className="max-w-7xl mx-auto px-6 sm:px-10 py-8 space-y-8">
            ...
            {/* High-Density Spacious App Cards Grid */}
