...
export const APP_CATALOG: AppStoreItem[] = [
  ...
  },
  {
    ...
    category: 'Writing & Research',
    description: 'Explore preprints in CS, AI, Math, Physics, and Biology directly from Cornell arXiv.',
  ...
  },
  {
    ...
    category: 'Writing & Research',
    description: 'Search textbooks and literature with ISBNs and borrow links from Internet Archive.',
